...
class MedicationsControllerTest < ActionController::TestCase
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post :create, medication: { dateEntered: @medication.dateEntered, frequency: @medication.frequency, name: @medication.name, petID: @medication.petID }
    end
  ...
  test "should update medication" do
    patch :update, id: @medication, medication: { dateEntered: @medication.dateEntered, frequency: @medication.frequency, name: @medication.name, petID: @medication.petID }
    assert_redirected_to medication_path(assigns(:medication))
  end
