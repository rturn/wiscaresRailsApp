...
class VetsControllerTest < ActionController::TestCase
  ...
  test "should create vet" do
    assert_difference('Vet.count') do
      post :create, vet: { address: @vet.address, contact: @vet.contact, name: @vet.name, petID: @vet.petID, userID: @vet.userID }
    end
  ...
  test "should update vet" do
    patch :update, id: @vet, vet: { address: @vet.address, contact: @vet.contact, name: @vet.name, petID: @vet.petID, userID: @vet.userID }
    assert_redirected_to vet_path(assigns(:vet))
  end
