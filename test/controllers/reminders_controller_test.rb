...
class RemindersControllerTest < ActionController::TestCase
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post :create, reminder: { dateToRemind: @reminder.dateToRemind, description: @reminder.description, petID: @reminder.petID, userID: @reminder.userID }
    end
  ...
  test "should update reminder" do
    patch :update, id: @reminder, reminder: { dateToRemind: @reminder.dateToRemind, description: @reminder.description, petID: @reminder.petID, userID: @reminder.userID }
    assert_redirected_to reminder_path(assigns(:reminder))
  end
