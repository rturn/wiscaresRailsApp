...
class VaccinationsControllerTest < ActionController::TestCase
  ...
  test "should create vaccination" do
    assert_difference('Vaccination.count') do
      post :create, vaccination: { dateEntered: @vaccination.dateEntered, dateGiven: @vaccination.dateGiven, name: @vaccination.name, petID: @vaccination.petID }
    end
  ...
  test "should update vaccination" do
    patch :update, id: @vaccination, vaccination: { dateEntered: @vaccination.dateEntered, dateGiven: @vaccination.dateGiven, name: @vaccination.name, petID: @vaccination.petID }
    assert_redirected_to vaccination_path(assigns(:vaccination))
  end
